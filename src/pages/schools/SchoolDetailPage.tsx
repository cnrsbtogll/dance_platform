      ...
      <div className="min-h-screen bg-gray-50 pt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center py-20">
            <h3 className="text-lg font-medium text-gray-900">Okul bulunamadı</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {activeTab === 'about' && (
          <div className="bg-white rounded-xl shadow-md overflow-hidden p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Okul Hakkında</h2>
        ...
        {activeTab === 'courses' && (
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Okulun Kursları</h2>
            ...
            {!coursesError && courses.length === 0 ? (
              <div className="bg-white rounded-xl shadow-md p-6 text-center">
                <p className="text-gray-500">Bu okul için henüz kayıtlı kurs bulunmuyor.</p>
              </div>
            ) : (
              !coursesError && (
        ...
        {activeTab === 'instructors' && (
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Okulun Eğitmenleri</h2>
            <div className="bg-white rounded-xl shadow-md p-6 text-center">
              <p className="text-gray-500">Bu okul için eğitmen bilgileri henüz eklenmemiştir.</p>
            </div>
          </div>
        )}
        ...
        {activeTab === 'gallery' && (
          <div>
            ...
            {!school.images || school.images.length === 0 ? (
              <div className="bg-white rounded-xl shadow-md p-6 text-center">
                <p className="text-gray-500">Bu okul için henüz fotoğraf eklenmemiştir.</p>
              </div>
            ) : (
