            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              <div className="relative h-64 sm:h-80 bg-gray-200">
                ...
                <div className="absolute bottom-4 left-4">
                  ...
                  <span className="ml-2 inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-white shadow-md text-gray-800">
              ...
              <div className="p-6">
                <div className="flex flex-col lg:flex-row justify-between">
                  <div className="flex-1">
                    <h1 className="text-2xl font-bold text-gray-900 sm:text-3xl">{course.name}</h1>
                ...
                <div className="mt-6">
                  <h2 className="text-lg font-medium text-gray-900">Kurs Bilgileri</h2>
                  <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div className="flex items-center">
                      <svg className="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
                      </svg>
                      <span className="text-gray-600">Süre: {course.duration} dakika</span>
                    </div>
                    <div className="flex items-center">
                      <svg className="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    {course.recurring && course.daysOfWeek && (
                      <div className="flex items-center">
                        ...
                        <span className="text-gray-600">Günler: {course.daysOfWeek.join(', ')}</span>
                      </div>
                    )}
                    {course.time && (
                      <div className="flex items-center">
                        ...
                        <span className="text-gray-600">Saat: {course.time}</span>
                      </div>
                    )}
                  </div>
                </div>
                ...
                {course.location && (
                  <div className="mt-6">
                    <h2 className="text-lg font-medium text-gray-900">Lokasyon</h2>
                    <div className="mt-2 text-gray-600">
