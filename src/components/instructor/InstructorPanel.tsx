              ...
              {showAddClassForm ? (
                <div className="mb-6">
                  <CreateClassForm 
                    user={user}
                    onSuccess={() => {
                      console.log('CreateClassForm başarıyla tamamlandı, showAddClassForm:', false);
                      console.log('refreshClassList çağrılıyor...');
                ...
                <div>
                  ...
                  <ClassList 
                    user={user}
                    onEdit={(classId) => {
                      console.log(`Düzenlenecek ders ID: ${classId}`);
                    }}
                    onRefresh={() => console.log('Yenileme isteği')}
                    ...
                    emptyComponent={
                      <div className="text-center py-8 bg-gray-50 rounded-lg border border-gray-200">
                        ...
                        <p className="text-gray-500 mb-4">Henüz kurs bulunmuyor</p>
                        <button
                          onClick={() => setShowAddClassForm(true)}
