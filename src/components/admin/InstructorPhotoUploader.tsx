...
interface InstructorPhotoUploaderProps {
...
const InstructorPhotoUploader: React.FC<InstructorPhotoUploaderProps> = ({
  currentPhotoURL,
  onImageChange,
  maxSizeKB = 500,
  maxWidth = 800,
      ...
      >
        ...
        <Box
          ...
          sx={{
            ...
            width: 200,
            height: 200,
            borderRadius: '50%', // Eğitmen fotoğrafları için yuvarlak yapalım
            overflow: 'hidden',
...
export default InstructorPhotoUploader; 