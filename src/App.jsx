...
function App() {
  ...
  useEffect(() => {
    ...
    // Şimdilik kullanıcıyı hep giriş yapmış kabul ediyoruz
    setIsAuthenticated(true);
    setUser({
      id: "user123",
      name: "Ahmet Yılmaz",
      email: "ahmet@example.com",
      photoURL: "/assets/images/dance/profile.jpg"
    });
    setLoading(false);
  }, []);
        ...
        <footer className="bg-gray-800 text-white py-8">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="/progress" className="text-gray-300 hover:text-white">İlerleme Durumu</a></li>
                  <li><a href="/admin" className="text-gray-300 hover:text-white">Yönetim Paneli</a></li>
                </ul>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-700 text-center text-gray-400 text-sm">
              <p>© 2023 Dans Platformu. Tüm Hakları Saklıdır.</p>
            </div>
          </div>
        </footer>
      </div>
